    ...
    public partial class HeroiBatalha_IdentidadeSecreta : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IdentidadesSeccretas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IdentidadesSeccretas_Herois_HeroiId",
                        column: x => x.HeroiId,
                        principalTable: "Herois",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IdentidadesSeccretas_HeroiId",
                table: "IdentidadesSeccretas",
                column: "HeroiId",
                unique: true);
        }
